...
def initialization(json_file_present, test_case, dir_output, dir_cent, write_samples=False):

    if json_file_present:
        potential_branches, initial_seeds = initialize_json(test_case, dir_output, dir_cent, write_samples)
    else:
...
def initialize_json(test_case, dir_output, dir_cent, write_samples=False):
    """
